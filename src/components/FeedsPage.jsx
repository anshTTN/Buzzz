          ...
          <div className="col align-self-center">
            ...
            <div className="col align-self-center" >
              ...
              <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                  <textarea placeholder="Write your thoughts..." name="postText" onChange={handlePostText}  cols="50" rows="10"></textarea>
                </Modal.Body>
                {addPostImage!=null?
                ...
                <Modal.Footer>
                  ...
                  <input style={{display:"none"}}  type="file" name="" id=""  onChange={addImage} />
                  </label>
                  <Button variant="primary" className="postBtn" onClick={createPost}>
                    Post  
                  </Button>
                </Modal.Footer>
